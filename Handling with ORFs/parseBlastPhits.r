...
#' @examples
#' x="Kasumi-1 StringTie-based proteome, blastp hits table.txt"
#' pr="Kasumi-1 StringTie-based proteome, full set of in silico proteins.fasta"
#' workDir="D:/Vasily Grinev"
#' res <- parseBlastPhits(x=x, pr=pr, workDir=workDir)
#' @export
