...
#' @description Vectorization of the ORF(-s) sequence(-s) to sequence features.
#' @param x DNAStringSet object with ORF(-s) sequence(-s).
#' @return The object of class data.frame with ORF(-s) vectorized into sequence
#'     features.
...
vectorizeORFs = function(x){
    ...
    ### Consolidation of all ORF features in a single object of class data
    #   frame.
